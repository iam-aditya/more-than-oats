...
const items = [
	...
	{ id: "fs-mango", categoryId: "fruit_smoothie", name: "Mango Smoothie", description: "Rich mango smoothie packed with beta carotene, vitamin C & potassium, finished with juicy mango chunks, sweet, refreshing and energizing.", price: 149, image: "images/mango_smoothie.jpeg" },
	{ id: "fs-papaya", categoryId: "fruit_smoothie", name: "Papaya Smoothie", description: "Refreshing papaya smoothie blended with ripe papaya and soaked chia seeds naturally rich in fiber, antioxidants and omega 3s to support digestion, hydration and sustained energy.", price: 149, image: "images/papaya_smoothie.jpeg" },
	{ id: "fs-strawberry", categoryId: "fruit_smoothie", name: "Strawberry Smoothie", description: "Naturally sweet strawberry smoothie blended with real strawberries and soaked chia seeds, packed with antioxidants, fibre and omega 3s to support hydration, digestion and natural energy.", price: 149, image: "images/strawberry_smoothie.jpeg" },
];
